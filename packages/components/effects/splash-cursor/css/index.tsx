...
import styles from './splash-cursor.module.css';
...
export interface SplashCursorProps {
  ...
  /** Resolution used for certain capture operations */
  ...
  PRESSURE?: number;
  /** Number of Jacobi iterations for pressure solver */
  PRESSURE_ITERATIONS?: number;
  /** Amount of vorticity/curl for swirling effects */
  CURL?: number;
  /** Radius of the splash effect */
  SPLAT_RADIUS?: number;
  /** Force of the fluid splash on interaction */
  SPLAT_FORCE?: number;
  /** Toggle simple lighting/shading */
  SHADING?: boolean;
  /** Frequency of color randomization */
...
function SplashCursor({
  ...
  return (
    <div className={`${styles.splashCursor} ${className}`}>
      <canvas ref={canvasRef} id="fluid" className={styles.splashCanvas} />
    </div>
  );
}
