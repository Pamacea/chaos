...
const ElectricBorder: React.FC<ElectricBorderProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none" style={strokeStyle} ref={strokeRef} />
      <div className="absolute inset-0 pointer-events-none" style={glow1Style} />
      <div className="absolute inset-0 pointer-events-none" style={glow2Style} />
